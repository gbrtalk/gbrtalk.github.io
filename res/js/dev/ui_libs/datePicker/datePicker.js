 ...
 * $Id: datePicker.js 24068 2013-01-21 07:32:13Z hao.lin $			:
 */
;(function($, window, document, undefined) {
	...
	Plugin.prototype.init = function() {
		...
		if(!root.length) {
			...
			$('<div class="caltime"><button type="button" class="btn btn_submit fr" name="submit">确定</button><input id="calHour" type="number" class="input" min="0" max="23" size="2" value="0"><span>点</span><input id="calMin" class="input" type="number" size="2" min="1" max="59" value="0"><span>分</span></div>').appendTo(body);
